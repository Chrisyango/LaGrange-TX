...
<head>
	...
	<title>LaGrange, TX - Freeform</title>
		...
		<nav>
			<ul id="nav">
				...
				<li>
					...
					<ul>
						<li><a href="./">malesuada sollicitudin</a></li>
						<li><a href="./">vestibulum ipsum</a></li>
						<li>
							<a href="./">adipiscing ipsum</a>
							<ul>
						...
						<li><a href="./">adipiscing ligula ornare</a></li>
						<li><a href="./">ligula dolor justo</a></li>
						<li><a href="./">malesuada tortor tristique</a></li>
						<li><a href="./">vehicula bibendum</a></li>
						<li><a href="./">inceptos pellentesque</a></li>
						<li><a href="./">purus magna dolor</a></li>
...
<section id="slider">
	<img id="inner-whitespace" src="./_assets_/images/inner-whitespace.png" alt="Whitespace">
	<ul class="bxslider">
		...
		<div class="row">
			<div class="col-md-3">
				<aside id="side-content">
					<div id="flyout-wrap">
						...
						<ul id="flyout">
							<li><a href="./">nibh ridiculus pharetra</a></li>
							<li><a href="./">condimentum euismod amet</a></li>
							<li>
								<a href="./">pellentesque ultricies ornare cras</a>
								<ul>
									<li><a href="./">this is a link</a></li>
									<li><a href="./">this is a link</a></li>
									<li><a href="./">this is a link</a></li>
							...
							<li><a href="./">quam nullam risus aenean mattis</a></li>
							<li><a href="./">egestas elit sollicitudin dapibus</a></li>
							<li><a href="./">pellentesque egestas vestibulum</a></li>
							<li><a href="./">consectetur nullam lorem</a></li>
							<li><a href="./">pharetra cursus nullam</a></li>
							<li><a href="./">vestibulum quam nibh ridiculus</a></li>
							<li><a href="./">pharetra condimentum euismod</a></li>
							<li><a href="./">amet pellentesque ultricies</a></li>
							<li><a href="./">ornare cras quam nullam risus</a></li>
							<li><a href="./">aenean mattis egestas elit</a></li>
						</ul><!-- /#flyout -->
					</div><!-- /#flyout-wrap -->
				</aside><!-- /#side-content -->
			</div><!-- col-md-3-->
			...
			<div class="col-md-9">
				...
				<nav id="breadcrumbs">
					...
					<div id="post">
						<p>
							Cras justo odio, dapibus ac facilisis in, egestas eget quam. Nulla vitae elit libero, a pharetra augue. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.
						</p>
						<img src="./_assets_/images/inner-img.jpg" alt="Interior image">
						<span class="subheader">header two</span>
						<p>
							Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Etiam porta sem malesuada magna mollis euismod. Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Cras mattis consectetur purus sit amet fermentum. Donec sed odio dui.
						</p>
						<p>
							Curabitur blandit tempus porttitor. Maecenas faucibus mollis interdum. Aenean lacinia bibendum nulla sed consectetur. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam porta sem malesuada magna mollis euismod. Curabitur blandit tempus porttitor.
						</p>
						<ul>
						...
						<p>
							Nullam id dolor id nibh ultricies vehicula ut id elit. Curabitur blandit tempus porttitor. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Etiam porta sem malesuada magna mollis euismod.
						</p>
					</div><!-- /#post -->
				</article><!-- /#entry -->
			</div><!-- /.col-md-9 -->
